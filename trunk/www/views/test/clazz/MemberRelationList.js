 ...
 */
app.controller('MemberRelationListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","MemberRelationService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,MemberRelationService) {
     ...
     */
    $scope.init=function(){
        $log.debug("MemberRelationList ctrl init ");
	    $scope.page.where=Storage.get("MemberRelationList"+"QueryWhere");
		$scope.page.pageNo=1;
