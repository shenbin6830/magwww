 ...
 */
app.controller('CashmemberStatiDayListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","CashmemberStatiDayService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,CashmemberStatiDayService) {
    ...
    $scope.first=function(){
        CashmemberStatiDayService.first($scope.page).then(function (data) {
