 ...
 * MemberListCtrl 会员列表
 */
app.controller('MemberListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","MemberService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,MemberService) {
