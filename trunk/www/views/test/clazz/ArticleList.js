 ...
 */
app.controller('ArticleListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","ArticleService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,ArticleService) {
