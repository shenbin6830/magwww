 ...
 */
app.controller('QuestionShowCtrl', ["$scope","$log","$state","$stateParams","Storage","ENV","QuestionService",function ($scope,$log,$state,$stateParams,Storage,ENV,QuestionService) {
