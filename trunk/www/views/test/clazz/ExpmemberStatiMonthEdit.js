 ...
 */
app.controller('ExpmemberStatiMonthEditCtrl', ["$scope","$log","$state","$stateParams","$location","Storage","ENV","ExpmemberStatiMonthService",function ($scope,$log,$state,$stateParams,$location,Storage,ENV,ExpmemberStatiMonthService) {
