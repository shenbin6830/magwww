 ...
 */
app.controller('OrderrQuickEditCtrl', ["$scope","$log","$state","$stateParams","$location","Storage","ENV","OrderrQuickService",function ($scope,$log,$state,$stateParams,$location,Storage,ENV,OrderrQuickService) {
