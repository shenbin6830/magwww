 ...
 */
app.controller('ScoreHisListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","ScoreHisService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,ScoreHisService) {
    ...
    $scope.first=function(){
        ScoreHisService.first($scope.page).then(function (data) {
