 ...
 */
app.controller('ArticlechannelListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","ArticlechannelService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,ArticlechannelService) {
