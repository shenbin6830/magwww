 ...
 */
app.controller('QuickLinkMemberViewListCtrl', ["$scope","$log","$state","$location","Storage","ENV","CommonService","QuickLinkMemberViewService",function ($scope,$log,$state,$location,Storage,ENV,CommonService,QuickLinkMemberViewService) {
    ...
    $scope.init=function(){
	    ...
	    $scope.page.where=Storage.get("QuickLinkMemberViewList"+"QueryWhere");
		$scope.page.pageNo=1;
